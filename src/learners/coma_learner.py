...
class COMALearner:
    ...
    def train(self, batch: EpisodeBatch, reward_learner, t_env: int, episode_num: int):
        ...
        # print("CHECK actions shape",len(batch["actions"][:]),len(actions[0]),actions[0][0])
        ...
        # initial icm 
        intrinsic_rewards = reward_learner.train(batch,t_env,episode_num)
        total_rewards = intrinsic_rewards + rewards
        q_vals, critic_train_stats = self._train_critic(batch, total_rewards, terminated, actions, avail_actions,
        ...
        # print("CHECK q_vals shape:", q_vals.shape)
        ...
        for t in range(batch.max_seq_length - 1):
            ...
            # print("CHECK agent_out shape:", agent_outs.shape)
            mac_out.append(agent_outs)
        # print("CHECK mac_out:",len(mac_out),mac_out)
        ...
        # print("CHECK pi shape",pi.shape)
        baseline = (pi * q_vals).sum(-1).detach()
        # print("CHECK baseline shape:", baseline.shape)
        ...
        # print("COMA_LOSS",coma_loss.shape)
        ...
        if t_env - self.log_stats_t >= self.args.learner_log_interval:
            ...
            for key in ["critic_loss", "critic_grad_norm", "td_error_abs", "q_taken_mean", "target_mean"]:
                # print("CHEKC place in coma_learner:", critic_train_stats.device)

...
data = pd.read_csv('E:\\study\\Thesis\\epymarl\\results\\rware\\FINAL_mappo_tiny.csv')
...
if __name__ == '__main__':
    ...
    plt.savefig("E:/study/Thesis/epymarl/results/rware/MAPPO-TINY-4g.png",dpi=500,bbox_inches = 'tight')
    plt.show()